...
ActiveRecord::Schema[7.0].define(version: 20_241_108_054_244) do
  ...
  create_table 'quiz_sessions', force: :cascade do |t|
    ...
    t.json 'courses_filter', default: []
    t.json 'semesters_filter', default: []
    t.json 'sections_filter', default: []
    t.json 'quiz_data', default: {}
    t.integer 'current_score', default: 0
    t.datetime 'expires_at'
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.integer 'answer'
    t.integer 'correct_student_id'
    t.integer 'streak', default: 0
    t.integer 'total_questions', default: 0
    t.integer 'correct_answers', default: 0
    t.index ['expires_at'], name: 'index_quiz_sessions_on_expires_at'
